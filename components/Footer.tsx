const Footer = () => (
  <section className="footer">
    ...
    <ul>
      <li>
        <a href="https://www.linkedin.com/in/maryam-tavakoli/" target="_blank">
    ...
    <style jsx>{`
      ...
      .linkedin {
        width: 50px;
        height: 50px;
        -webkit-mask: url("../static/icons/linkedin.svg") no-repeat center;
      ...
      .facebook {
        width: 50px;
        height: 50px;
        -webkit-mask: url("../static/icons/facebook.svg") no-repeat center;
        mask: url("../static/icons/facebook.svg") no-repeat center;
        background-color: white;
      }
      .facebook:hover {
        background-color: var(--light-french);
